...
if("TRUE" STREQUAL "TRUE")
  set(mynt_eye_ros_wrapper_SOURCE_PREFIX /home/nvidia/AV/src/MYNT-EYE-S-SDK/wrappers/ros/src/mynt_eye_ros_wrapper)
  set(mynt_eye_ros_wrapper_DEVEL_PREFIX /home/nvidia/AV/devel/.private/mynt_eye_ros_wrapper)
  ...
  set(mynt_eye_ros_wrapper_INSTALL_PREFIX /home/nvidia/AV/install)
...
if(NOT "/home/nvidia/AV/devel/.private/mynt_eye_ros_wrapper/include " STREQUAL " ")
  set(mynt_eye_ros_wrapper_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/AV/devel/.private/mynt_eye_ros_wrapper/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mynt_eye_ros_wrapper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/AV/src/MYNT-EYE-S-SDK/wrappers/ros/src/mynt_eye_ros_wrapper/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/AV/devel/.private/mynt_eye_ros_wrapper/lib;/home/nvidia/AV/devel/lib;/opt/ros/kinetic/lib)
